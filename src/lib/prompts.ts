...
export const CORE_VISUAL_PROFILES: Record<string, string> = {
  ...
  // 新增关键 NPC
  老门卒: 'An elderly, hunched Chinese gatekeeper, deeply wrinkled face, sparse grey eyebrows, wearing a coarse brown tunic, holding a heavy iron key ring.',
  酒肆管事: 'A bustling middle-aged Chinese man with a wide, sweating face, dressed in a loose white linen tunic, wiping a wooden counter with a grease-stained cloth.',
  抄书童: 'A small, frail Chinese boy in his early teens, ink-stained fingers, wide curious eyes, oversized beige robe, carrying a bundle of bamboo scrolls.',
  纸铺掌柜: 'A shrewd elderly man with keen, bird-like eyes, hunched posture, wearing a dark blue scholar-style robe, holding a magnifying lens to inspect paper texture.',
  驿卒: 'A sun-scorched, dusty young man in travel-worn leather armor, eyes hollow from exhaustion, holding a sealed, dust-covered military report tube.',
  刀匠: 'A muscular middle-aged blacksmith, face blackened by soot, arms covered in scars from heat, wearing a heavy, sleeveless leather apron over a thin shirt.',

  // 通用 NPC 模板
  唐代伙计: 'A young, energetic Chinese waiter, simple cloth headband, plain grey tunic, apron, holding a steaming wooden tea tray.',
  唐代书生: 'A thin, pale young man, wearing a simple cloth headpiece, long white robe, carrying a small leather book satchel, thoughtful expression.',
  胡商: 'A robust man with a thick beard and curly hair, vibrant silk Tang robe, heavy gold earrings, carrying a large fabric goods sack.'
};
