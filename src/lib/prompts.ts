...
注意：即使地点相同，只要人物、动作、时间、光线或情绪变化，也要给出新的当前镜头描述。人物不要看镜头，表情必须反映当前叙事情绪。
