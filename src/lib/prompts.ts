...
VISUAL: none / glitch / memory / ending
INPUT: options / free
...
## 视觉事件
默认写 VISUAL: none。只有当矛盾版本被追问、时空错位、或林深关键信造成短暂失真时，才写 VISUAL: glitch 或 VISUAL: memory。只有第三幕真正收束、玩家已经面对本线最终问题时，才允许写 VISUAL: ending。视觉事件要稀有，不要连续触发。`;
}
